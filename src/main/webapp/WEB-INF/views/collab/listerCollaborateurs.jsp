		...
		<div class="row">
			<div class="col">
				<div class="float-right">
					<a class="btn btn-dark" href="creer-collab.html" role="button">Ajouter
						un collaborateur</a>
				</div>
			</div>
					...
					<form>
						<div class="form-row">
							<div class="col-12 col-md-3">
								<label for="inputName" class="col">Rechercher un nom ou
							...
							<div class="form-check col-md-3">
								<input class="form-check-input" type="checkbox" value=""
									...
									for="defaultCheck1"> Voir les collaborateurs désactivés
								</label>
							</div>
						</div>
						<br>
						<div class="form-row">
							<div class="col-12 col-md-3">
								<label for="inputName" class="col">Filtrer par
									département:</label>
							</div>
							<div class="col-12 col-md-3">
					...
					<div class="card-body">
						<div class="row">
							<div class="col-12 col-xl-6">
								<img src="<%=request.getContextPath()+collab.getPhoto()%>" alt="profil_picture" class="img-thumbnail">
							</div>
							<div class="col-12 col-xl-6">
								...
								<a href="editer-collab.html" class="btn btn-dark float-right"
